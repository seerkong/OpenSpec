...
const FILE_PATHS: Record<SlashCommandId, string> = {
  ...
  'design-architect': '.crush/commands/openspec/design-architect.md',
  'init-architect': '.crush/commands/openspec/init-architect.md',
  'refine-architect': '.crush/commands/openspec/refine-architect.md',
  'sync-code-to-architect': '.crush/commands/openspec/sync-code-to-architect.md',
